...
export default function FeedbackButton() {
  ...
  return (
    <>
      ...
      {/* Rendered through a portal so the modal escapes the card's
          stacking context. Inline it was trapped inside a `z-10` wrapper
          that the later-in-DOM `z-10` footer outranked, so the footer
          painted over the dialog. At the body level its own z-[220] wins. */}
      {createPortal(
        <AnimatePresence>
          {open && (
              <motion.div
