...
import NextGameTimer from "@/pages/NextGameTimer";
...
import { prefetchUnlockedGames } from "@/games/registry";
import { fetchSummary, fetchLeaderboard } from "@/api/logPlaySession";
import { confirmDialog } from "@/ui/confirmDialog";
import BrandLoader from "@/ui/BrandLoader";
import GameIcon from "@/ui/GameIcon";
import WeeklyGoals from "@/pages/WeeklyGoals";
import { LOGO_URL } from "@/ui/brand";
import PublicLanding from "@/pages/PublicLanding";
import FeedbackButton from "@/ui/FeedbackButton";
import { useInstallOffer, useLowPower } from "@/pwa/pwa";
...
function BetaHomeContent() {
  ...
  useEffect(() => {
    ...
    // Warms every game this player can open. The game list lives in the
    // registry, so a new game is prefetched automatically — no edit here.
    const prefetch = () => prefetchUnlockedGames(isGameUnlockedNow, isTeacher);
        ...
        >
          <div className="mx-auto flex w-full max-w-4xl flex-wrap items-center justify-between gap-2 px-3 py-3 sm:px-6">
            <motion.button
              ...
              onMouseEnter={() => import("@/pages/GameAccessPanel").catch(() => {})}
              onFocus={() => import("@/pages/GameAccessPanel").catch(() => {})}
              onTouchStart={() => import("@/pages/GameAccessPanel").catch(() => {})}
